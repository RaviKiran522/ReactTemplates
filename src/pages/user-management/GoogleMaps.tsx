  ...
  return (
    <>
      ...
      <Box mt={2}>
        ...
        <Typography>Address: {addressDetails.address}</Typography>
        <Typography>Latitude: {addressDetails.lat}</Typography>
        <Typography>Longitude: {addressDetails.lng}</Typography>
      </Box>
    </>
  );
}
