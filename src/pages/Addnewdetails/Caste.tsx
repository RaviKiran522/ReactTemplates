...
export default function Caste() {
  ...
  const handleFormSubmit = () => {
    ...
    const newRecord = {
        sno: (data.length + 1).toString(), // Generate a new serial number based on the length of the array
         // Assuming formData contains the new name
        caste: formData.casteName, // Defaulting caste to REDDY
  ...
  const initailData: any = [
    ...
    { sno: "2",caste:"SETTY", status: "Enable" },
    { sno: "3",caste:"MALA", status: "Enable" },
    { sno: "4",caste:"KAAPU", status: "Enable" },
    { sno: "5",caste:"MADHIGA", status: "Enable" },
    { sno: "6",caste:"REDDY", status: "Enable" },
    { sno: "7",caste:"REDDY", status: "Enable" },
    { sno: "8", caste:"REDDY", status: "Enable" },
    { sno: "9", caste:"REDDY", status: "Enable" }
  ];
