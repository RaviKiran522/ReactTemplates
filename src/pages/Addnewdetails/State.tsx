...
export default function State() {
  ...
  const initailData: any = [
    { sno: "1", name: "TELANGANA",country:"INDIA", status: "Enable" },
    { sno: "2", name: "ANDHRAPRADESH",country:"INDIA", status: "Enable" },
    { sno: "3",name: "MAHARASTRA",country:"INDIA", status: "Enable" },
    { sno: "4", name: "TAMILNADU",country:"INDIA", status: "Enable" },
    { sno: "5", name: "KARNATAKA",country:"INDIA", status: "Enable" },
    { sno: "6", name: "HIMACHALPRADESH",country:"INDIA", status: "Enable" },
    { sno: "7", name: "UTTARPRADESH",country:"INDIA", status: "Enable" },
    { sno: "8",name: "ODISHA",country:"INDIA", status: "Enable" },
    { sno: "9", name: "KASHMIR",country:"INDIA", status: "Enable" }
  ];
