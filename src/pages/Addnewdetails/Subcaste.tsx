...
export default function Caste() {
  ...
  const handleFormSubmit = () => {
    ...
    const newRecord = {
        ...
        subcaste: formData.subcasteName, 
  ...
  const initailData: any = [
    ...
    { sno: "6",caste:"REDDY",subcaste:"OC", status: "Enable" },
    { sno: "7",caste:"REDDY",subcaste:"OC", status: "Enable" },
    { sno: "8", caste:"REDDY",subcaste:"OC", status: "Enable" },
    ...
    <>
      ...
      <Dialog open={openPopup} onClose={() => setOpenPopup(false)} maxWidth="sm" fullWidth>
        ...
        <DialogContent>
                ...
                <MenuItem value="KAAPU">KAAPU</MenuItem>
                <MenuItem value="SETTY">SETTY</MenuItem>
                <MenuItem value="MAADHIGA">MAADHIGA</MenuItem>
                </Select>
             </FormControl>
             <TextField
            fullWidth
