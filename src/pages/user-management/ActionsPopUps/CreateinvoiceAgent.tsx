...
const AgentCreateInvoice: React.FC<AddpaymentProps> = ({ open, onClose }) => {
    interface FormField {
        label: string;
        id: string;
        name: string;
    ...
    const handleFormSubmit = (e: React.FormEvent) => {
        ...
        if (validate()) {
            const sampleObject = {
                ...
                agentId: formData.agentId.value,
                agentName: formData.agentName.value,
    ...
    return (
        <Dialog open={true} fullWidth maxWidth="sm">
            <DialogTitle>
                <Typography >Create Agent Invoice</Typography>
            </DialogTitle>
            <DialogContent>
                    ...
                    <form onSubmit={handleFormSubmit} noValidate>
                        <Grid container spacing={2}>
                            <Grid item xs={12} sm={6}>
                                <CommonSelectField inputProps={formData.agentId} onSelectChange={handleSelectChange} />
                            </Grid>
                            <Grid item xs={12} sm={6}>
                                <CommonSelectField inputProps={formData.agentName} onSelectChange={handleSelectChange} />
                            </Grid>
                            <Grid item xs={12} sm={6}>
...
export default AgentCreateInvoice;
