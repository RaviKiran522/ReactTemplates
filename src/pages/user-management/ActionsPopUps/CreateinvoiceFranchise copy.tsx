...
const FranchiseCreateInvoice: React.FC<AddpaymentProps> = ({ open, onClose }) => {
    interface FormField {
        label: string;
        id: string;
        name: string;
    ...
    const formFields: FormData = {
        ...
        franchiseName: {
            label: 'Farnchise Name',
            id: 'franchiseName',
            name: 'franchiseName',
            type: 'select',
            options: [
                { id: 1, label: 'Guntur Head Office' },
                { id: 2, label: 'Vijayawad' },
                { id: 3, label: 'Ongole' },
            ],
            value: { id: 1, label: '' },
            error: false,
    ...
    const handleFormSubmit = (e: React.FormEvent) => {
        ...
        if (validate()) {
            const sampleObject = {
                ...
                farnchiseId: formData.farnchiseId.value,
                franchiseName: formData.franchiseName.value,
    ...
    return (
        <Dialog open={true} fullWidth maxWidth="sm">
            <DialogTitle>
                <Typography >Create Franchise Invoice</Typography>
            </DialogTitle>
            <DialogContent>
                    ...
                    <form onSubmit={handleFormSubmit} noValidate>
                        <Grid container spacing={2}>
                            <Grid item xs={12} sm={6}>
                                <CommonSelectField inputProps={formData.farnchiseId} onSelectChange={handleSelectChange} />
                            </Grid>
                            <Grid item xs={12} sm={6}>
                                <CommonSelectField inputProps={formData.franchiseName} onSelectChange={handleSelectChange} />
                            </Grid>
                            <Grid item xs={12} sm={6}>
...
export default FranchiseCreateInvoice;
