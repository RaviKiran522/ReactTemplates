...
//   };
  ...
  const initailData: any = [
    { sno: "1",district:"HYDERABADH", name: "TELANGANA",country:"INDIA", status: "Enable" },
    { sno: "2",district:"HYDERABADH", name: "ANDHRAPRADESH",country:"INDIA", status: "Enable" },
    { sno: "3",district:"HYDERABADH",name: "MAHARASTRA",country:"INDIA", status: "Enable" },
    { sno: "4",district:"HYDERABADH", name: "TAMILNADU",country:"INDIA", status: "Enable" },
    { sno: "5",district:"HYDERABADH", name: "KARNATAKA",country:"INDIA", status: "Enable" },
    { sno: "6",district:"HYDERABADH", name: "HIMACHALPRADESH",country:"INDIA", status: "Enable" },
    { sno: "7",district:"HYDERABADH", name: "UTTARPRADESH",country:"INDIA", status: "Enable" },
    { sno: "8",district:"HYDERABADH",name: "ODISHA",country:"INDIA", status: "Enable" },
    { sno: "9",district:"HYDERABADH", name: "KASHMIR",country:"INDIA", status: "Enable" }
  ];
