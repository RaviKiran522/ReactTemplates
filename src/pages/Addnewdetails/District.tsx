...
export default function District() {
  ...
  const initailData: any = [
    { sno: "1",district:"HYDERABADH",counrty:"INDIA",state:"ANDHRAPRADESH",status: "Enable" },
    { sno: "2",district:"HYDERABADH",counrty:"INDIA",state:"TELANGANA", status: "Enable" },
    { sno: "3",district:"HYDERABADH",counrty:"INDIA",state:"KARNATAKA", status: "Enable" },
    { sno: "4",district:"HYDERABADH",counrty:"INDIA",state:"ODISHA", status: "Enable" },
    { sno: "5",district:"HYDERABADH",counrty:"INDIA",state:"TAMILANADU", status: "Enable" },
    { sno: "6",district:"HYDERABADH",counrty:"INDIA",state:"BIHAR", status: "Disable" },
    { sno: "7",district:"HYDERABADH",counrty:"INDIA",state:"DELHI", status: "Enable" },
    { sno: "8",district:"HYDERABADH", counrty:"INDIA",state:"KERALA", status: "Disable" },
    { sno: "9",district:"HYDERABADH", counrty:"INDIA",state:"GUJARAT", status: "Enable" }
  ];
