...
export default function Interests() {
  ...
  const handleFormSubmit = () => {
    if (validate()) {
      ...
      const newRecord = {
        ...
        interests: formData.interestsName.value, // Defaulting religion to B.tech
  ...
  const initailData: any = [
    { sno: "1", interests: "PLAYING CRICKET", status: "Enable" },
    { sno: "2", interests: "READING BOOKS", status: "Disable" },
    { sno: "3", interests: "WATCHING MOVIES", status: "Enable" },
    { sno: "4", interests: "BIKE RIDING", status: "Disable" },
    { sno: "5", interests: "TOURS", status: "Enable" },
    { sno: "6", interests: "PLAYING CRICKET", status: "Enable" },
    { sno: "7", interests: "PLAYING CRICKET", status: "Enable" },
    { sno: "8", interests: "PLAYING CRICKET", status: "Enable" },
    { sno: "9", interests: "PLAYING CHESS", status: "Enable" }
  ];
  ...
  const columns = useMemo(
    () => [
      ...
      { header: "interests Name", accessorKey: "interests" },
      {
        header: "Status",
        accessorKey: "status",
  ...
  const handleEdit = (row: any) => {
    ...
    newFormData.interestsName.value = row.interests; // Map "country" to "countryName"
  ...
  return (
    <>
      ...
      <Dialog open={openPopup} maxWidth="sm" fullWidth>
        <DialogTitle> Create interests</DialogTitle>
        <DialogContent>

          <Grid item xs={12} padding={2}>
            <CommonInputField inputProps={formData.interestsName} onChange={handleChange} />
          </Grid>
