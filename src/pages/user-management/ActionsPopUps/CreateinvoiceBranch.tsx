...
const BranchCreateInvoice: React.FC<AddpaymentProps> = ({ open, onClose }) => {
    interface FormField {
        label: string;
        id: string;
        name: string;
    ...
    return (
        <Dialog open={true} fullWidth maxWidth="sm">
            <DialogTitle>
                <Typography >Create Branch Invoice</Typography>
            </DialogTitle>
            <DialogContent>
                    ...
                    <form onSubmit={handleFormSubmit} noValidate>
                        <Grid container spacing={2}>
                            <Grid item xs={12} sm={6}>
                                <CommonSelectField inputProps={formData.branchId} onSelectChange={handleSelectChange} />
                            </Grid>
                            <Grid item xs={12} sm={6}>
                                <CommonSelectField inputProps={formData.branchName} onSelectChange={handleSelectChange} />
                            </Grid>
                            <Grid item xs={12} sm={6}>
...
export default BranchCreateInvoice;
