...
const FranchiseStaffCreateInvoice: React.FC<AddpaymentProps> = ({ open, onClose }) => {
    interface FormField {
        label: string;
        id: string;
        name: string;
    ...
    return (
        <Dialog open={true} fullWidth maxWidth="sm">
            <DialogTitle>
                <Typography >Create Franchise Staff Invoice</Typography>
            </DialogTitle>
            <DialogContent>
...
export default FranchiseStaffCreateInvoice;
